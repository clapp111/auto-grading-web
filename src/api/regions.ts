...
export const regionsApi = {
  ...
  saveTemplate: (examId: number, regions: RegionTemplateItem[]) =>
    apiClient
      .put<ApiResponse<AnswerRegionResponse[]>>(
        `/exams/${examId}/region-template`,
        { regions },
      )
      .then((r) => r.data),
  ...
  applyTemplate: (examId: number) =>
    apiClient
      .post<ApiResponse<JobStartedResponse>>(
        `/exams/${examId}/regions/apply-template`,
      )
      .then((r) => r.data),
  ...
  getSheetRegions: (sheetId: number) =>
    apiClient
      .get<ApiResponse<AnswerRegionResponse[]>>(
        `/answer-sheets/${sheetId}/regions`,
      )
      .then((r) => r.data),
  ...
  addRegion: (sheetId: number, body: AnswerRegionCreateRequest) =>
    apiClient
      .post<ApiResponse<AnswerRegionResponse>>(
        `/answer-sheets/${sheetId}/regions`,
        body,
      )
      .then((r) => r.data),
  ...
  updateRegion: (regionId: number, body: AnswerRegionUpdateRequest) =>
    apiClient
      .patch<ApiResponse<AnswerRegionResponse>>(
        `/answer-regions/${regionId}`,
        body,
      )
      .then((r) => r.data),
