...
export const sheetsApi = {
  ...
  getPresignedUrl: (
    ...
    apiClient
      .post<ApiResponse<AnswerSheetPresignedUrlResponse>>(
  ...
  completeUpload: (sheetId: number) =>
    apiClient
      .post<ApiResponse<UploadCompleteResponse>>(
        `/answer-sheets/${sheetId}/complete`,
      )
      .then((r) => r.data),

  delete: (sheetId: number) =>
    apiClient
      .delete<ApiResponse<null>>(`/answer-sheets/${sheetId}`)
      .then((r) => r.data),

  patch: (sheetId: number, body: AnswerSheetPatchRequest) =>
    apiClient
      .patch<ApiResponse<AnswerSheetResponse>>(
        `/answer-sheets/${sheetId}`,
        body,
      )
      .then((r) => r.data),
  ...
  getDownloadUrl: (sheetId: number) =>
    apiClient
      .get<ApiResponse<AnswerSheetDownloadResponse>>(
        `/answer-sheets/${sheetId}/download`,
      )
      .then((r) => r.data),
