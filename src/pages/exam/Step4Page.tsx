          ...
          {sheets.map((sheet, i) => {
            ...
            return (
              ...
              >
                ...
                {sheet.student_no && (
                  <span className="text-[11.5px] font-mono text-[#9aa0ab]">
                    {sheet.student_no}
                  </span>
                )}
                {isActive && (
      ...
      >
        ...
        {active && (
          <span
            ...
            style={{
              background: TYPE_COLORS[active.type] + "20",
              color: TYPE_TEXT_COLORS[active.type],
            }}
          >
            ...
            return (
              ...
              >
                <span
                  ...
                  style={{ background: isMapped ? "#d1d4da" : dot }}
                />
                ...
                <span
                  ...
                  style={
                    isMapped
                      ? { background: "#f0f1f4", color: "#c2c6cd" }
                      : { background: dot + "20", color: txt }
                  }
                >
          ...
          <div className="flex-[2.5] bg-[#eceef2] p-[24px] flex flex-col min-w-0">
            ...
            <div className="flex items-center gap-[8px] mb-[14px] flex-none">
              ...
              <ProblemSelect
                ...
                mappedLabels={
                  new Set(mappingList.map((item) => item.problemLabel))
                }
              />
          ...
          <div className="flex-1 border-l border-[#f0f1f4] min-w-0">
            <RegionMappingPanel
              mappingList={[...mappingList]
                .sort((a, b) =>
                  a.problemLabel.localeCompare(b.problemLabel, undefined, {
                    numeric: true,
                  }),
                )
              ...
              onDeleteServer={(id) =>
                deleteRegion(id, selectedSheet?.answer_sheet_id ?? 0)
              }
