...
export default function LoginModal({ open, onClose, onSwitchToSignup }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-[23px] font-extrabold text-[#15171d] tracking-[-0.02em]">
          로그인
        </h2>
        <p className="text-sm text-[#71757e] mt-1 mb-6">
          채점을 이어서 진행하세요
        </p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          <div className="flex items-center justify-between mt-[14px] mb-[22px]">
            <label className="flex items-center gap-[7px] cursor-pointer">
              ...
              <span className="text-[13.5px] text-[#4b4f57] font-medium">
                로그인 유지
              </span>
            </label>
            <button
              type="button"
              className="text-[13.5px] text-accent font-semibold"
            >
              비밀번호 찾기
            </button>
          </div>
